...
ProbablyEngine.rotation.register_custom(102, '|cfffa0ae4Balance Squad BETA|r', {
 ...
 -- { "Moonkin Form", "!player.buff(Moonkin Form)"},
  ...
  -- Mouseover Support
   { "Lunar Strike",{ "player.buff(Lunar Empowerment)", "player.buff(Owlkin Freny" }},
